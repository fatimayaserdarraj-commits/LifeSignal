    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={refreshing}
          className="rounded-md border border-border bg-surface2 px-4 py-2 text-sm font-medium text-gray-200 hover:border-coral hover:text-coral disabled:opacity-50"
        >
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
        <MetricCard label="Incidents Tracked" value={metrics?.incidents_tracked ?? null} accent />
        <MetricCard
        ...
        <MetricCard
          ...
          suffix="%"
        />
        <MetricCard label="High-Risk Zones" value={metrics?.high_risk_zones_identified ?? null} />
        <MetricCard
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="h-96 overflow-hidden rounded-xl border border-border">
          <RiskZoneMap zones={zones} />
        </div>
        <div className="h-96 overflow-y-auto">
          <RiskZoneList zones={zones} />
        </div>
      </div>
    </div>
  );
